...
{#if abilityId === Ticket.None}
    <div class="ticket-container">
        <img class="ticket-icon empty-ticket"src="https://cdn.wikimg.net/en/splatoonwiki/images/c/c3/S2_Icon_Drink_Ticket.png" alt="No Ticket"/>
    </div>
