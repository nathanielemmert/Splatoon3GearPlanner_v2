...
export function createGear(gearInfo:GearInfo){
    ...
    local_how_far_to_check.subscribe((value)=>{wasmGear.how_far_to_check=value});// TODO: Should this be computed_how_far_to_check instead of local_how_far_to_check?
